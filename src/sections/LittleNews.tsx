...
export default function LittleNews() {
    return (
        <>
            ...
            <article>
                Aug 2025: Two papers coming out soon: <em><a href="https://arxiv.org/abs/2505.24246" target="_blank">Locating Risk: Task Designers and the Challenge of Risk Disclosure in RAI Content Work</a></em>, accepted to CSCW 2026, and <em><a href="https://dl.acm.org/doi/full/10.1145/3772318.3791558" target="_blank">Worker Discretion Advised: Co-designing Risk Disclosure in Crowdsourced, which we presented at CHI2026 in Barcelona.
Responsible AI (RAI) Content Work</a></em>, accepted to CHI 2026. These projects were led by Alice Q. Zhang, and supported by myself, Ziqi Yang, Laura Dabbish, Jina Suh, and Hong Shen.  
            </article>
            <article>
